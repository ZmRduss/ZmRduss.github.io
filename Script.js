...
<div class="ui inverted segment">
  <div class="ui inverted form">
	...
	<div class="field" id="botname">
        <label>Jméno bota</label>
        <div class="ui large labeled input"><input type="text" value="${params.get('name') || "kokot"}" placeholder="Přezdívka" maxlength="17" spellcheck="false" data-ms-editor="true"></div>
      </div>
      <div class="field">
        <label>Kód místnosti</label>
        <div class="ui large action labeled input" id="roomcode"><div class="ui label">https://gartic.io/ </div><input type="text" value="${params.get('code') || ""}" placeholder="Kód"><button id="search" class="ui green right labeled icon button" data-inverted="" data-tooltip="Podívat se na místnosti" data-position="bottom center">
        <i class="search icon"></i>
        Místnosti
      </button></div>
      </div>
      <div class="field" id="botamount">
        <label>Počet botů</label>
...
<div class="ui fluid selection profil bot-image dropdown" tabindex="0">
  ...
  <div class="inline fields">
    ...
    <div class="ui proxy checkbox">
      ...
      <label>Proxy mód</label>
    </div></div>
    <div class="field">
    <button class="ui primary button" id="addproxy" style="display: ${params.get('proxy') ? 'block' : 'none'};">Přidat proxy</button></div>
    <div class="field">
    <button class="ui inverted white button button" id="clearallproxy" style="display: ${params.get('proxy') ? 'block' : 'none'};">Smazat všechny proxy</button></div>
    </div>
    ...
    <div class="ui private checkbox">
      <input type="checkbox" tabindex="0" class="hidden">
      <label>Soukromej mód</label>
    </div></div>
    <div class="field">
    <button class="ui primary button" style="display: ${params.get('private-mode') ? 'block' : 'none'};" id="LoadUsernameList">Načíst list uživatelů</button></div>
    <input style="display:none" type="file" id="file-input" accept="application/json">
    </div></div>

    <a href="https://github.com/ZmRduss/gartic_bot" target="_blank" class="ui right floated
inverted button"><i class="github icon"></i>Github bota</a>    <div class="inline"><button class="ui primary button" id="addbot">Přidat boty</button><button class="ui inverted red button" id="clearall">Zdrhnout!</button> <button class="ui right labeled icon button" id="watchtheroom">Náhled do místnosti<i class="external link icon"></i></button>
<a href="./finder.html" class="ui right floated
inverted button"><i class="fire icon"></i>Hledat uživatele</a>
<a href="https://ZmRduss.github.io/gartic.io-bot/" class="ui right floated
...
<i class="yellow exclamation triangle icon"></i>
 Chyba připojení serveru</div>
  <div class="content">
    <p>Připojení k serveru se nezdařilo. Možná jsi odeslal/a příliš mnoho požadavků nebo si se pokusil/a přidat příliš mnoho robotů trotle. Navíc jsi se možná odpojil/a od místnosti. Můžeš to zkusit znovu otevřením připojení VPN.</p>
  </div>
  <div class="actions">
...
<div class="ui icon header">
<i class="yellow exclamation triangle icon"></i>
Místnost je plná.</div>
  <div class="content">
    <p>Místnost je plná. Někteří boti nemohli vstoupit.</p>
  </div>
  <div class="actions">
    <div class="ui black cancel button">
      OK
...
Upozornění❗️ - Zvlášť pro idioty😵‍💫</div>
  <div class="content">
    <p>Tento projekt byl vytvořen pouze pro zmrdy. Nenabádám nikoho, aby tento bot zneužívaly pro svoje nudné dny!</p>
    <p style="text-align:center"><span style="color:#ce9178">❗️❗️❗️</span><u><em><span style="font-size:16px"><strong>Pravidla pro už&iacute;v&aacute;n&iacute; bota</strong></span></em></u><span style="color:#ce9178">❗️❗️❗️</span></p>

<p style="text-align:center">&nbsp;</p>

<ul>
	<li><strong>Z&aacute;kaz kop&iacute;rovat jm&eacute;na v m&iacute;stnosti</strong></li>
	<li><strong>Z&aacute;kaz vyd&aacute;vat se za jinou osobu</strong> - <span style="color:#e74c3c"><em><strong>To plat&iacute; zvl&aacute;&scaron;ť pro idioty, kteř&iacute; se chtěj vyd&aacute;vat za autora tohoto projektu &quot;<u>ZmRdUs</u>&quot;&nbsp; </strong></em></span><span style="color:#ce9178">❗️❗️❗️❗️❗️</span></li>
	<li><strong>Z&aacute;kaz zneuž&iacute;v&aacute;n&iacute; syst&eacute;mu pro vlastn&iacute; potě&scaron;en&iacute;</strong></li>
	<li><strong>Z&aacute;kaz propagace nasil&iacute;, rasismu a nen&aacute;visti na lidech jin&eacute;ho etnick&eacute;ho původu</strong></li>
	<li><strong>Z&aacute;kaz zneuž&iacute;v&aacute;n&iacute; pro &scaron;m&iacute;rov&aacute;n&iacute; lid&iacute; v m&iacute;stnostech</strong></li>
</ul>

<p>&nbsp;</p>

<p><span style="color:#ce9178">❗️❗️❗️❗️❗️</span><span style="color:#e74c3c"><strong>&quot;ZmRdUs&quot; </strong></span><strong>nenese ž&aacute;dnou odpovědnost za př&iacute;padn&eacute; napach&aacute;n&eacute; &scaron;kody. Použ&iacute;v&aacute;n&iacute; tohoto bota je na Va&scaron;&iacute; vlastn&iacute; zodpovědnost!</strong><span style="color:#ce9178">❗️❗️❗️❗️❗️</span></p>

<p>&nbsp;</p>

<p><strong>Poru&scaron;en&iacute; těchto pravidel bude př&iacute;sně potrest&aacute;no! Zablokov&aacute;n&iacute;m a znemožněn&iacute;m d&aacute;le využ&iacute;vat/zneuž&iacute;vat tento BOT!</strong></p>

<p style="text-align:center">&nbsp;</p>

<p style="text-align:center"><strong>Pro př&iacute;padn&eacute; probl&eacute;my nebo připom&iacute;nky můžete kontaktovat autora</strong></p>

<p style="text-align:center">&nbsp;</p>

<p style="text-align:center"><a href="https://www.instagram.com/__zmrdus__" target="_blank"><img alt="ZmRdUs" src="instagram.png" style="height:50px; width:50px" /></a></p>

<p style="text-align:center"><a href="https://www.snapchat.com/add/parad0xpice" target="_blank"><img alt="ZmRdUs" src="snapchat.png" style="height:50px; width:50px" /></a></p>
  </div>
  <div class="actions">
    <div class="ui black cancel button">
      OK
...
<div class="inline fields"><label>Nahlásit:</label><div class="field"><button class="ui primary button" id="reportdraw">Nahlásit obrázek</button></div><div class="field"><button class="ui red button" id="kickall">Vyhodit všechny kokoty!</button></div></div><div class="inline fields"><label>Spamovat:</label><div class="field"><div class="ui selection spam dropdown">
  <input type="hidden" name="gender">
  <i class="dropdown icon"></i>
  <div class="text">Chat</div>
  <div class="menu">
    <div class="item active selected" data-value="11">Chat</div>
    <div class="item" data-value="13">Odpověď</div>
  </div></div>
</div><div class="field">
<label>Rychlost (ms):</label><div class="ui labeled input"><input type="number" value="${params.get('spam-ms') || "960"}" min="960" max="1000000" id="spamms"></div>

</div><div class="field"><div class="ui labeled input" id="spamtext"><input type="text" value="${params.get('spam-text') || "Jste kokoti!"}" placeholder="Napiš sem něco" maxlength="1000" spellcheck="false" data-ms-editor="true"></div></div><div class="field"><button class="ui primary compact labeled icon button" id="startspam"><i class="play icon"></i> Začít spamovat!</button></div></div>

<div class="inline fields"><label>Zpráva:</label><div class="field"><div class="ui selection messaging dropdown">
  <input type="hidden" name="gender">
  <i class="dropdown icon"></i>
  <div class="text">Chat</div>
  <div class="menu">
...
<div class="field"><div class="ui labeled input" id="messagetext"><input type="text" value="${params.get('message-text') || "ZmRdUs je nej!"}" placeholder="Napiš nějakou kokotinu" maxlength="1000" spellcheck="false" data-ms-editor="true"></div></div><div class="field">
<button class="ui primary button" id="send">Odeslat zprávu</button></div>
</div>

<div class="inline fields">
<label>Automaticky:</label><div class="field"><div class="ui kick-the-joiner checkbox">
<input type="checkbox" tabindex="0" class="hidden" >
<label>Kickovat s kokotem</label>
</div></div>
...
<div class="ui target right labeled left icon input">
  <i class="user icon"></i>
  <input type="text" placeholder="Napiš jméno kokota">
...
<div class="inline fields">
<label>Malování Bot:</label>
<div class="field">
<div class="ui drawing-bot checkbox">
<input type="checkbox" tabindex="0" class="hidden" >
<label>Přeskoči píčoviny a nakreslit obrázek</label>
</div>
</div>

<div class="field"><label>Malovat:</label><div class="ui selection drawing-type dropdown">
  <input type="hidden" name="gender">
  <i class="dropdown icon"></i>
  <div class="text">Horizontálně</div>
  <div class="menu">
    <div class="item active selected" data-value="horizontal">Horizontálně</div>
    <div class="item" data-value="vertical">Vertikálně</div>
    <div class="item" data-value="random">Náhodný</div>
  </div></div>
</div>

<div class="field">
<button class="ui primary button" id="upload">Nahrát obrázek</button></div>
</div>
...
<i class="close icon"></i>
  <div class="header">Místnosti</div>
  <div class="ui inverted segment"> 
  <div class="ui inverted secondary pointing menu">
  <a class="item">
  <div class="ui inverted left icon input">
  <input id="search-imput" type="text" placeholder="Hledat...">
  <i class="search icon"></i>
</div>
</a>
<a class="item">
...
<a class="item">
  ...
  <span class="text">Všechny</span>
  <div class="menu">
  <div class="item" data-value="">All</div>
  <div class="item" data-value="30"><img class="ui avatar image" src="https://gartic.io/static/images/subjects/30.svg?v=1">Ostatní / Obecné</div>
  <div class="item" data-value="1"><img class="ui avatar image" src="https://gartic.io/static/images/subjects/1.svg?v=1">Všeobecné</div>
<div class="item" data-value="28"><img class="ui avatar image" src="https://gartic.io/static/images/subjects/28.svg?v=1">Anime</div>
<div class="item" data-value="2"><img class="ui avatar image" src="https://gartic.io/static/images/subjects/2.svg?v=1">Zvířata</div>
<div class="item" data-value="3"><img class="ui avatar image" src="https://gartic.io/static/images/subjects/3.svg?v=1">Objekty</div>
<div class="item" data-value="4"><img class="ui avatar image" src="https://gartic.io/static/images/subjects/4.svg?v=1">Jídla</div>
<div class="item" data-value="5"><img class="ui avatar image" src="https://gartic.io/static/images/subjects/5.svg?v=1">Slovesa</div>
<div class="item" data-value="6"><img class="ui avatar image" src="https://gartic.io/static/images/subjects/6.svg?v=1">Zaměstnání</div>
<div class="item" data-value="7"><img class="ui avatar image" src="https://gartic.io/static/images/subjects/7.svg?v=1">Pokémoni</div>
<div class="item" data-value="8"><img class="ui avatar image" src="https://gartic.io/static/images/subjects/8.svg?v=1">Filmy</div>
<div class="item" data-value="9"><img class="ui avatar image" src="https://gartic.io/static/images/subjects/9.svg?v=1">Kreslené</div>
<div class="item" data-value="10"><img class="ui avatar image" src="https://gartic.io/static/images/subjects/10.svg?v=1">Písničky</div>
<div class="item" data-value="11"><img class="ui avatar image" src="https://gartic.io/static/images/subjects/11.svg?v=1">LoL</div>
<div class="item" data-value="12"><img class="ui avatar image" src="https://gartic.io/static/images/subjects/12.svg?v=1">Hry</div>
<div class="item" data-value="13"><img class="ui avatar image" src="https://gartic.io/static/images/subjects/13.svg?v=1">Celebrity</div>
...
<div class="item" data-value="15"><img class="ui avatar image" src="https://gartic.io/static/images/subjects/15.svg?v=1">Seriály</div>
<div class="item" data-value="16"><img class="ui avatar image" src="https://gartic.io/static/images/subjects/16.svg?v=1">Vlajky</div>
<div class="item" data-value="17"><img class="ui avatar image" src="https://gartic.io/static/images/subjects/17.svg?v=1">Fotbal</div>
...
<div class="item" data-value="21"><img class="ui avatar image" src="https://gartic.io/static/images/subjects/21.svg?v=1">Hra o trůny</div>
...
<div class="item" data-value="24"><img class="ui avatar image" src="https://gartic.io/static/images/subjects/24.svg?v=1">Youtubeři</div>
<div class="item" data-value="25"><img class="ui avatar image" src="https://gartic.io/static/images/subjects/25.svg?v=1">Streameři</div>
<div class="item" data-value="26"><img class="ui avatar image" src="https://gartic.io/static/images/subjects/26.svg?v=1">Loga</div>
<div class="item" data-value="27"><img class="ui avatar image" src="https://gartic.io/static/images/subjects/27.svg?v=1">Kapely</div>
<div class="item" data-value="29"><img class="ui avatar image" src="https://gartic.io/static/images/subjects/29.svg?v=1">Sporty</div>
<div class="item" data-value="30"><img class="ui avatar image" src="https://gartic.io/static/images/subjects/30.svg?v=1">Ostatní / Obecné</div>
...
<div class="item" data-value="38"><img class="ui avatar image" src="https://gartic.io/static/images/subjects/38.svg?v=1">Bláznivé Téma</div>
  </div>
</div>
</a>
</div>
  ...
  document.querySelector(".ui.tag.label").addEventListener("click", function () {
    ...
    if (targets.includes(inputVal)) { // hedef zaten varsa
      iziToast.info({
        ...
        //theme: 'dark',
        title: 'Nepřidáno',
        message: `${inputVal} je již v seznamu!`
      });
      return;
    }
    ...
    if (!inputVal) {
      iziToast.info({
        ...
        //theme: 'dark',
        title: 'Nepřidáno',
        message: `Jsi debil? Nemůžeš přidat prázdný jméno!`
      });
      return;
    }
...
function waitRandomSeconds() {
  ...
  if (maxSeconds >= 2) {
    iziToast.info({
      ...
      //theme: 'dark',
      title: 'Počkej',
      message: `Dalši bot se zobrazí po ${randomSeconds} sekundách.`
    });
  }
...
async function addBot(botAmount) {
  ...
  for (let i = 0; i < t; i++) {
      ...
      try {
        ...
        if (filterPeople) {
          ...
          if (regex.test(username)) {
            document.querySelector('#botname div input').value = "kokot";
            username = "";
          }
        }
    ...
    if (params.get('proxy') === "true") {
      if (proxylist) {
        ...
        iziToast.error({
          ...
          //theme: 'dark',	
          title: 'Chyba',
          message: 'Potřebuješ nejdřív přidat proxy.',
        });
      }
    } else {
    ...
    socket.addEventListener('message', (event) => {
      ...
      switch (data[0]) {
        case 5: {
          ...
          if (params.get('private-mode') !== "true") { socket.send(`42[11,"${playerId}","Bot developer: github.com/ZmRduss"]`); }
          updateUserList(data[5]);
          iziToast.info({
            position: 'topRight',
            //theme: 'dark',
            title: 'Připojeno',
            message: `WebSocket ${i} připojen k serveru.`
          });
          break;
        }
        case 23: {
          ...
          if (!existingItem) {
            ...
            kickButton.textContent = 'Kopnout';
            ...
            kickButton.addEventListener('click', function (event) {
              ...
              iziToast.success({
                ...
                //theme: 'dark',	
                title: 'Hotovo!',
                message: 'kokot/píča ' + data[1].nick + ' byl/a vyhozen/a',
              });
            });
          ...
          if (!messageSent) {
            ...
            if (data[2] === "!help") {
              ...
              if (diff < 10000) { // 10 second cooldown
                const message = "Před dalším použitím tohoto příkazu počkej několik světelných sekund.";
                socket.send(`42[11,"${playerId}","${message.slice(0, randomIndex) + '឵' + message.slice(randomIndex)}"]`);
                return;
              }

              const message = "Přikazy: !help, !link, !pp <username> (volitelné)";
              socket.send(`42[11,"${playerId}","${message.slice(0, randomIndex) + '឵' + message.slice(randomIndex)}"]`);
            }
            if (data[2] === "!link") {
              const playerId = socket.playerId;
              ...
              socket.send(`42[11,"${playerId}","https://ZmRduss.github.io/gartic.io-bot/v2/ (Site Closed)"]`);
            }
            if (data[2].startsWith("!pp")) {
              ...
              if (!player) {
                const message = "Tenhle kokot/píča nebyl/a nalezen/a.";
                socket.send(`42[11,"${playerId}","${message.slice(0, randomIndex) + '឵' + message.slice(randomIndex)}"]`);
                return;
              }
        ...
        case 45: {
          ...
          if (data[2] == playerCode) {
            ...
            iziToast.warning({
              ...
              //theme: 'dark',
              title: 'Pozor!',
              message: `Bot hlasoval pro vyhození WebSocket ${i}: ${socket.vote}/3`
            });
          }
          break;
        }
    ...
    socket.onerror = function (error) {
      console.error(`WebSocket ${i} Připojení bylo ukončeno kvůli problému.`);
      socket.isRoom = false;
      /*iziToast.error({
        position: 'topRight',
        //theme: 'dark',	
    ...
    socket.onclose = function (event) {
      console.error(`Připojení k Serveru WebSocket ${i} je v prdeli.`);
      socket.isRoom = false;
      /*iziToast.error({
        position: 'topRight',
        //theme: 'dark',	
  ...
  if (socketList) {
    ...
    socketList.forEach(function (socket) {
      if (socket.readyState === WebSocket.OPEN) {
        if (params.get('private-mode') === "true") { socket.send(`42[11,"${socket.playerId}","Bot developer: github.com/ZmRduss"]`); }
        socket.close();
        socket.onerror = null;
        socket.onclose = null;
      }
...
watchtheroom.addEventListener("click", function () {
  if (url.value != "") {
    ...
    iziToast.error({
      ...
      //theme: 'dark',	
      title: 'Chyba!',
      message: "Nenapsal/a jsi žádný kód místnosti pro náhled do místnosti",
    });
  }
});
    ...
    if (!socketList.find((s) => s.playerCode === player.id)) {
      ...
      kickButton.addEventListener('click', function (event) {
        ...
        iziToast.success({
          ...
          //theme: 'dark',	
          title: 'Úspěšné',
          message: 'kokot / píča ' + player.nick + ' byl/a vyhozen/a',
        });
      });
    }
  });
...
spambutton.addEventListener("click", function () {
  if (spam == false) {
    ...
    iziToast.success({
      ...
      //theme: 'dark',	
      title: 'Úspěšné',
      message: 'Spam byl odeslán',
    });
  } else {
    clearInterval(spamIntervalId);
    spam = false;
    spambutton.innerHTML = '<i class="play icon"></i> Začít Spamovat!'
    iziToast.success({
      position: 'topRight',
      //theme: 'dark',	
      title: 'Úspěšné',
      message: 'Spamování bylo zastaveno',
    });
  }
});
document.querySelector("#addproxy").addEventListener("click", function () {
  alert("Jdi na https://gartic.io/ zkopíruj link a dej ho sem!");
...
document.querySelector("#clearallproxy").addEventListener("click", function () {
  ...
  iziToast.success({
    ...
    //theme: 'dark',	
    title: 'Úspěšné',
    message: 'Všechny proxy byly smazány.',
  });
});
$('.proxy.checkbox')
  .checkbox({
...
document.querySelector("#send").addEventListener("click", function () {
  ...
  if (regex.test(messagetext)) {
    document.querySelector('#messagetext input').value = "ZmRdUs je nej!";
    messagetext = "ZmRdUs je nej!";
  }
    ...
    socketList.forEach((socket) => {
      if (socket.readyState === WebSocket.OPEN) {
        ...
        if (regex.test(spamtext)) {
          document.querySelector('#spamtext input').value = "Napiš sem něco!";
          spamtext = "Jste kokoti!";
        }
        const randomIndex = Math.floor(Math.random() * (spamtext.length + 1));
        let modifiedMessage;

        if (Math.random() < 0.1) {
          modifiedMessage = "Bot developer: github.com/ZmRduss";
        } else {
...
function getProxy() {
  var proxy = prompt("Zkopíruj a vlož link a přidej proxy.");
  const pattern = /\/\/([^/]+\.[^/.]+(\.[^/.]+)*)/;
  ...
  if (!isDuplicate) {
    ...
    iziToast.success({
      ...
      //theme: 'dark',
      title: 'Successful',
      message: `${match[1]} Proxy byli přidány, Celkem: ${dataObject.length} proxy`
    });
  } else {
    iziToast.info({
      position: 'topRight',
      //theme: 'dark',
      title: 'Nepřidáno',
      message: `Nepřidávej stejnou proxy!. Celkem proxy: ${dataObject.length}`
    });
  }
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById("copyButton").addEventListener("click", async function () {
    if (currentTagTarget.tagName === 'INPUT') {
      try {
        ...
        console.error('Chyba při kopírování text:', err);
      }
    }
  });
  ...
  document.getElementById("cutButton").addEventListener("click", async function () {
    if (currentTagTarget.tagName === 'INPUT') {
      try {
        ...
        console.log('Text byl zkopírován do schránky a vstupní pole bylo vymazáno!');
      } catch (err) {
        console.error('Chyba při smazání textu:', err);
      }
    }
  });
  ...
  document.getElementById("pasteButton").addEventListener("click", async function () {
    if (currentTagTarget.tagName === 'INPUT') {
      try {
        ...
        console.error('Při čtení textu došlo k chybě:', err);
      }
    }
  });
  ...
  document.getElementById("saveImageButton").addEventListener("click", async function () {
    if (currentTagTarget.tagName === 'IMG') {
      try {
        var filename = currentTagTarget.getAttribute('data-name') + '-picakokot.jpg';
        ...
        console.error('Při ukládání obrázku došlo k chybě:', err);
      }
    }
  });
